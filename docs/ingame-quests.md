...
Focused replay targets: **Robin2003**, map50000, beginner job0 at level1–10 with quest1036 not started: open his quest menu, select Robin under “etc”, select “How do I move?”, and inspect the authored answer; reopening still offers the ordinary quest. His admitted Cosmic `scripts/npc/2003.js` is hashed `1bf6545a13bf10c97d286f626a5eac92aa9f82886fab665c285ec9060ee1e5fc`. For refusal, **Dances with Balrog1022000**, map102000003, warrior job100 at level10–19 with quest2400 not started: select his generic talk row, observe the retained quest menu plus unavailable `constants.game.GameConstants` authority reason, then select quest2400 normally. Those profile values are explicit setup, not evidence of acquisition. `client/test/npc-script-runtime.test.js` adds isolated blocked-menu retention and admitted callback handoff regressions; integrated native replay remains Main's verification responsibility.
