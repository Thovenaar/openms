...
const PATHS = [
  ...
  "CharSelect/effect/0/0",
  "CharSelect/effect/0/1",
  "CharSelect/effect/0/2",
  "CharSelect/effect/0/3",
  "CharSelect/effect/0/4",
  "CharSelect/effect/0/5",
  "CharSelect/effect/1/0",
  "CharSelect/effect/1/1",
  "CharSelect/effect/1/2",
  "CharSelect/effect/1/3",
  "CharSelect/effect/1/4",
  "NewChar/charName",
  "NewChar/charSet",
  "NewChar/statTb",
  "NewChar/scroll/0/0",
...
async function inspectCanvas(root, path, output) {
  ...
  return {
    ...
    a0: value(canvas, "a0") ?? null,
    a1: value(canvas, "a1") ?? null,
    file,
  };
}
