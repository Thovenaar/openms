...
- [Inspection console and port tools](inspection-tools.md): scoped XP/Windows95/Y2K themes, validated character presets, bounded entity search, and source audit tools. Native in-game artwork remains unthemed. [Binding actions](offline-binding-actions.md) records exact native IDs and remote dependencies.
