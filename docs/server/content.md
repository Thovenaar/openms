...
The package's [authoring migration](../../content/sql/001-content.sql) and [world migration](../../content/sql/002-world.sql) run through normal server startup migrations. They create their own tables and runtime-ID sequence; they do not modify original asset files or original reference-data tables. Uploads, definitions, modified map regions and compiled records are all stored in PostgreSQL. `client/public/generated/` remains an input.
