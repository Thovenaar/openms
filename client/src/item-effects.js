import { configureTemporaryState, temporaryState } from "./temporary-stats.js";
...
const UNAVAILABLE_FIELDS = Object.freeze({
  ...
  defenseAtt: "element-qualified incoming damage resistance",
...
function retainEffectAvailability(effect, field, amount) {
  if ((CARD_FLAGS.has(field) || CARD_PARAMETERS.has(field)) && !effect.card) {
