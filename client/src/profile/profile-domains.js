...
/** Cosmic SavedLocationType.java:24-35; exposed save/peek/get consumers retain map IDs. */
export const SAVED_LOCATION_TYPES = Object.freeze([
  "FREE_MARKET",
  "WORLDTOUR",
  "FLORINA",
  "INTRO",
...
/** Empty source-defined return slots; absent state is null, never a guessed destination. */
export function createSavedLocations() {
  const locations = {};
  for (const type of SAVED_LOCATION_TYPES) locations[type] = null;
  return locations;
}
