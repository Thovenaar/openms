...
import { NORMAL_UI_NAMES } from "../ui/game-ui.js";
import {
  saveKeys,
  cancelKeys,
  defaultKeys,
  clearKeys,
} from "../ui/ui-keyconfig.js";
import {
  captureQuickKey,
...
function describeActions(systems) {
  return {
    ...
    sources: {
      dispatch: "client/src/input/player-actions.js",
      keys: "client/src/input/keymap.js",
      input: "client/src/input/player-input.js",
      bindings: "client/src/input/key-bindings.js",
      ui: "client/src/ui/game-ui.js",
      chat: "client/src/ui/ui-chat.js",
      inventory: "client/src/items/item-use.js",
      interaction: "client/src/world/life-system.js",
      keyConfig: "client/src/ui/ui-keyconfig.js",
      quickslot: "client/src/ui/ui-quickslot-config.js",
    },
  };
}
