...
import { consumeItem } from "../items/inventory-model.js";
import { admitItem, selectedItem } from "../items/inventory-action-rules.js";
...
export class ReactorSystem {
  ...
  /** Ordinary close-range selection probes the same admission without consuming a hit. */
  canStrike(rect, facing, skillId = 0) {
    ...
    for (const record of this.records) {
      if (
        ...
        this.selectStrikeEvent(record, rect, facing, skillId)
      ) {
        return true;
      }
    }
