...
Enter `playtester` and `password` in the sign-in form, choose Sign in, then Enter the world. During gameplay, expand development tools, choose Diagnostics, and click Reconnect session.
...
- This recipe covers the development reconnect button. It does not prove browser-reload recovery, network-loss recovery, registration or password recovery.
